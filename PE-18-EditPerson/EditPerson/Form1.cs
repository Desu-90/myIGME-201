    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            {
                herRadioButton.Checked = true;
            }

            if(person.eGender == genderPronoun.him)
            {
                himRadioButton.Checked = true;
            }
            ...
            if (person.GetType() == typeof(Student))
            {
                ...
                if (student.eCollegeYear == collegeYear.sophomore)
                {
                    sophRadioButton.Checked = true;
                }

                if (student.eCollegeYear == collegeYear.junior)
                {
                    juniorRadioButton.Checked = true;
                }

                if (student.eCollegeYear == collegeYear.senior)
                {
                    seniorRadioButton.Checked = true;
                }
        ...
        private void SophRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rb.Checked == true)
            {
                this.classOfLabel.Text = "Class of 2020";
            }
        }
        ...
        private void JuniorRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rb.Checked == true)
            {
                this.classOfLabel.Text = "Class of 2019";
            }
        }
        ...
        private void SeniorRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rb.Checked == true)
            {
                this.classOfLabel.Text = "Class of 2018";
            }
        }
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if (this.himRadioButton.Checked == true)
            {
                person.eGender = genderPronoun.him;
            }

            if (this.herRadioButton.Checked == true)
            {
                person.eGender = genderPronoun.her;
            }

            if (this.themRadioButton.Checked == true)
            {
            ...
            if( person.GetType() == typeof( Student))
            {
                ...
                if(this.freshRadioButton.Checked == true)
                {
                    student.eCollegeYear = collegeYear.freshman;
                }
                if (this.sophRadioButton.Checked == true)
                {
                    student.eCollegeYear = collegeYear.sophomore;
                }
                if (this.juniorRadioButton.Checked == true)
                {
                    student.eCollegeYear = collegeYear.junior;
                }
                if (this.seniorRadioButton.Checked == true)
                {
